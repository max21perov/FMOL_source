...
<form method="post" name="opeForm" action="/fmol/page/mail/handle_mail.php?myaction=sendMail" >
<input type="hidden" name="to_team_id" value="<?=$team_id?>" />
      ...
      <tr class="gSGRowOdd_input">
        <td><table width="100%"  border="0" cellpadding="1" cellspacing="1">
            ...
            <tr>
              ...
              <td colspan="2"><input type="text" class="inputField" name="subject" style="width:250px " /></td>
            </tr>
            <tr>
              <td align="right">Message:&nbsp;</td>
              <td colspan="2"><textarea class="inputField" name="content" style="width:250px;" rows="6" ></textarea></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
