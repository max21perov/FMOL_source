        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
		 <tr>
			<td colspan="7" class="gSGSectionTitle"><div align="right" class="gSGSectionTitle"> Filter&nbsp;:&nbsp;
					...
					&nbsp;&nbsp;match type: 
					<select name="type_filter_select" onChange="changeFixturesFilter(this.form)">
            ...
            <tr>
              ...
              <td class="gSGSectionColumnHeadings" width="16%" >tactics</td>
            </tr>
            <!-- BEGIN fixtures -->
            <tr class="{FIXTURES_TR_CLASS}">
              ...
              <td ><select name="select" style="width:90px; display:{NOT_PLAYED_DISPLAY} ">
                  <option>tactics A</option>
                  <option>tactics B</option>
                  <option>tactics C</option>
                </select>
              </td>
            </tr>
            <!-- END fixtures -->
