...
function changePositionType(control) {
	var frm = document.forms["transfer_market_form"];
	var position_filter = control.value; 
	frm.action = "/fmol/page/transfer/transfer_market.php?position_filter=" + position_filter;
    ...
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#0069b9">
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" >
		  <form name="transfer_market_form" method="post" action="/fmol/page/transfer/handle_transfer.php" >
            <tr>
              <td class="gSGSectionTitle"><div class="gSGSectionTitle">&nbsp;Transfer Market </div></td>
            ...
            <tr>
              <td class="ProText" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
                  <tr>
                    ...
                    <td class="gSGSectionColumnHeadings">Start Price</td>
                    <td class="gSGSectionColumnHeadings">bids</td>
                  </tr>
                  <!-- BEGIN transfer_market -->
                  ...
                  <tr class="{TRAN_TR_CLASS}"  onClick="clickRow(this)" >
                    ...
                    <td class="BlackText">{START_PRICE}</td>
