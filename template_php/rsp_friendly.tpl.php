            ...
            <form method="post" action="/fmol/page/friendly/handle_friendly.php?myaction=acceptRspFriendly&next_page={NEXT_PAGE}&friendly_filter={FRIENDLY_FILTER}" onSubmit="javascript:return OnClickConfirm(this, 2)">
              <tr class="{RSP_FRIENDLY_TR_CLASS}">
                <td>&nbsp;{STATUS}</td>
                <td>{USER_NAME}</td>
                ...
                <td align="right"><input type="hidden" name="friendly_id" value="{FRIENDLY_ID}">
                    ...
                    <input name="accept_rsp_friendly" type="submit" class="button" value="accept">
