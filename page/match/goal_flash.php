      ...
      <tr>
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
            ...
            <td width="20" align="center">-&gt;</td>
            <td width="100" align="center" nowrap><a href="<?=$_SERVER['REQUEST_URI']?>">Goal Flash</a></td>
            <td>&nbsp;</td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
        <tr>
          <td><table cellspacing="0" class="TableMenu">
              <tr>
                <td class="ButtonSel">Goal Flash</td>
                
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><?php  require_once("goal_flash_maker.php");  ?></td>
        </tr>
      </table>
