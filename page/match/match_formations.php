        ...
        <tr>
          <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="TableMenu">
			  ...
			  <tr>
                ...
                <td class="ButtonSel">Formations</td>
                <td class="ButtonPro"><a href="/fmol/page/match/match_logs.php?match_type=<?=$_GET["match_type"]?>&match_id=<?=$_GET["match_id"]?>">Match Logs</a></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td> <?php require_once ("match_formations_maker.php") ?>
		    <!-- <iframe src="match_formations_maker.php?match_id=<?=$_GET['match_id']?>" frameborder="0" width="100%" height="700" marginwidth="0" marginheight="0"></iframe> -->
		 </td>
        </tr>
      </table>
