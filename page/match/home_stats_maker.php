...
$tpl->setVariable("PRIMARY_TEAM_ID", $match_team_arr['home_team_id']) ;
$tpl->setVariable("TEAM_NAME", $match_team_arr['home_team_name']) ;
			
			
/**
 * get the team stats
 */
$team_stats_arr = getTeamStats($db, $match_type, $match_id, $home_team_id);
