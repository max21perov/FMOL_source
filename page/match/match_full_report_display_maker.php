...
$tpl->loadTemplatefile("match_report_display.tpl.php", true, true); 
 ...
 */
$full_highlight = 0;   // 0 - full comment
$comment_info = getCommentInfo($db, $match_type, $match_id, $full_highlight);

displayMatchReport($db, $tpl, $comment_info);

//$tpl->setVariable("COMMENT_CONTENT", $comment_info["comment"]);
