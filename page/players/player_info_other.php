            ...
            <td><table width="100%" bgColor="#0069b9" border="0" cellpadding="0" cellspacing="0">
             ...
             <?php 		    
					...
					{   
					    ...
					    if (doubleval($season_remains) <= 0.5)  // free transfer
					    {
				?>
              <tr>
               
                <td class="MenuText">&nbsp;&nbsp;<a href="/fmol/page/transfer/invite_join_free_transfer.php?player_id=<?=$player_id?>">&nbsp;Free Transfer</a></td>
              ...
              <tr>
                ...
                <td class="MenuText">&nbsp;&nbsp;<a href="/fmol/page/transfer/give_price_switch.php?player_id=<?=$player_id?>">&nbsp;Give a price</a></td>
