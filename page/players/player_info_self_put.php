            ...
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="MenuText">&nbsp;
				  		...
				  		<a href="/fmol/page/transfer/put_to_transfer.php?player_id=<?=$player_id?>">Put to transfer</a>
                ...
                <tr>
                  <td class="MenuText">&nbsp;
						<a href="/fmol/page/players/extend_contract.php?player_id=<?=$player_id?>">Extend Contract</a>
                  </td>
                </tr>
				<?php
				    }			
