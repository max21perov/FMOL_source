      ...
      <tr>
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
            ...
            <td width="110" align="center" nowrap><a href="/fmol/page/players/player_list.php">Player List</a></td>
          ...
          <tr>
            <td><table width="100%" bgColor="#0069b9" border="0" cellpadding="0" cellspacing="0">
              <tr>
				...
				<?php 		 
					$player_id = $_GET['player_id'];   
					if ($sign_contract == "0" && $contract_negotiating == "0" && 
						$transfer_flag == "0" && $retire_after_contract == "0" && 
					    doubleval($season_remains) > 0.5) {
				?>
				
              <tr>
                
                <td class="MenuText">&nbsp;&nbsp;<a href="/fmol/page/transfer/cancel_transfer.php?myaction=cancelFromTransfer&player_id=<?=$player_id?>">Cancel transfer</a>
                 </td>
              </tr>
				...
				<?php 		    
					if ($sign_contract == "0" && $contract_negotiating == "0" && 
						$transfer_flag == "0" && $retire_after_contract == "0" &&
						$free_transfer_buffer_id == "" ) 
					{
				?>
				
				
			  <tr>
				  <td class="MenuText">&nbsp;&nbsp;<a href="/fmol/page/players/extend_contract.php?player_id=<?=$player_id?>">Extend Contract</a>
				</td>
              </tr>
				<?php
				    }			
