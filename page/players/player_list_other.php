        ...
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
			...
			<!-- InstanceBeginEditable name="EditNavigation" -->
	 		...
	 		<td width="110" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Player List</a></td>
            <td>&nbsp;</td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="TableMenu" >
              <tr>
                <td width="50%" class="ButtonSel">Player List</td>
                <td width="50%" class="ButtonPro">Other</td>
              </tr>
          </table></td>
        </tr>
        <tr>
		  ...
		  <?php 
		    $team_id = $_GET["team_id"];
		    require_once ('player_list_maker.php'); 
		  ?>
          </td>
        </tr>
      </table>
