      ...
      <tr>
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
            ...
            <td width="120" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Fridnely Pool</a></td>
            <td>&nbsp;</td>
        ...
        <tr>
          <td><table cellspacing="0" class="TableMenu">
              <tr>
                ...
                <td class="ButtonSel">Friendly Pool </td>
                <td class="ButtonPro"><a href="/fmol/page/friendly/friendly_arrange.php">Arrange Friendly </a></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><?php require_once('friendly_pool_maker.php'); ?></td>
        </tr>
      </table>
