      ...
      <tr>
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
            ...
            <td width="120" align="center" nowrap><a href="/fmol/page/friendly/friendly_list.php">Friendly List</a></td>
            <td width="20" align="center">-&gt;</td>
            <td width="120" align="center"><a href="/fmol/page/friendly/friendly_pool.php">Fridnely Pool</a></td>
            <td width="20" align="center">-&gt;</td>
            <td width="120" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Arrange Fridnely</a></td>
            <td>&nbsp;</td>
  ...
  <tr class="BodyTable">  
	...
	<!-- InstanceBeginEditable name="EditMain" -->
      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
        <tr>
          <td><table cellspacing="0" class="TableMenu">
              <tr>
                <td class="ButtonPro"><a href="/fmol/page/friendly/friendly_list.php">My Friendly List </a></td>
                <td class="ButtonPro"><a href="/fmol/page/friendly/friendly_pool.php">Friendly Pool </a></td>
                <td class="ButtonSel">Arrange Friendly </td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><?php require_once('friendly_arrange_maker.php'); ?></td>
        </tr>
      </table>
