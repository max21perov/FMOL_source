...
<table width="995" border="0" align="center" cellpadding="0" cellspacing="1">
      ...
      <tr>
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
            ...
            <td width="110" align="center" nowrap><a href="/fmol/page/players/player_list.php">Coach List</a></td>
            <td width="20" align="center">-&gt;</td>
            <td width="110" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Coach Info</a></td>
            <td>&nbsp;</td>
            ...
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="MenuTitle">&nbsp;Action</td>
				 		...
				 		<form name="sign_coach_form" method="post" 
						     action="/fmol/page/transfer/handle_coach.php?myaction=signCoach&coach_id=<?=$coach_id?>">
                <tr>
                  <td class="MenuText">&nbsp;
				  		   <a href="#" onClick="javascript:document.forms['sign_coach_form'].submit();">Sign</a>
				 </td>
						</form>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="100%" cellspacing="0" class="TableMenu" >
              <tr>
                <td width="25%" class="ButtonSel">Coach Info</td>
        ...
        <tr>
		  ...
		  <?php 
			...
			require_once ('coach_info_maker.php'); 
		  ?>
          </td>
        </tr>
      </table>
  ...
  <tr>
	...
	<!-- InstanceBeginEditable name="EditAction" -->	<!-- InstanceEndEditable --></td>
  </tr>
</table>
</body>
<!-- InstanceEnd --></html>
