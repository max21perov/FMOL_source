        ...
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
			...
			<!-- InstanceBeginEditable name="EditNavigation" -->
	 		...
	 		<td width="80" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Search</a></td>
            <td>&nbsp;</td>
	...
	<!-- InstanceBeginEditable name="EditMain" -->
     <table width="100%" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <table width="100%" bgcolor="#999999" >
        <tr>
          <td class="TextPro"><form name="form1" method="get" action="/fmol/page/search/search_result.php">
        Please input target team's ID :
            <input name="team_id" type="text" class="inputField" >
