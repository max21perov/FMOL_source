...
<table width="995" border="0" align="center" cellpadding="0" cellspacing="1">
      ...
      <tr>
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
            ...
            <td width="80" align="center" nowrap><a href="/fmol/page/search/search.php">Search</a></td>
            <td width="20" align="center">-&gt;</td>
            <td width="120" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Search Result</a></td>
            <td>&nbsp;</td>
  ...
  <tr class="BodyTable">  
	...
	<?php require_once ("search_result_maker.php"); ?>
