...
<table width="995" border="0" align="center" cellpadding="0" cellspacing="1">
        ...
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
			...
			<!-- InstanceBeginEditable name="EditNavigation" -->
	 		...
	 		<td width="80" align="center" nowrap><a href="/fmol/page/division/league.php?team_id=<?=$_GET['team_id']?>">League</a></td>
            <td width="20" align="center">-&gt;</td>
            <td width="80" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Schedule</a></td>
            <td>&nbsp;</td>
  ...
  <tr class="BodyTable">  
	...
	<?php 
	  ...
	  require_once (DOCUMENT_ROOT . "/template_php/menu_other.tpl.php");
	?>
	<!-- InstanceEndEditable -->
      </div></td> 
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
        <tr>
          <td><table width="100%" cellspacing="0" class="TableMenu">
              <tr>
                <td width="25%" class="ButtonPro" nowrap><?php $team_id = $_GET["team_id"]; ?><a href="/fmol/page/division/league.php?team_id=<?=$team_id?>">Premiership League </a></td>
                <td width="25%" class="ButtonSel">Schedule</td>
                <td width="25%" class="ButtonPro">States</td>
                <td width="25%" class="ButtonPro">History</td>
              </tr>
          </table></td>
        </tr>
        <tr>
		  ...
		  <?php 
		    $team_id = $_GET["team_id"];
			require_once ("schedule_maker.php"); 
		  ?>
		  </td>
        </tr>
      </table>
