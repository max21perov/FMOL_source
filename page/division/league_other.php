...
<table width="995" border="0" align="center" cellpadding="0" cellspacing="1">
        ...
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
			...
			<!-- InstanceBeginEditable name="EditNavigation" -->
	 		...
	 		<td width="80" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">League</a></td>
            <td>&nbsp;</td>
  ...
  <tr class="BodyTable">  
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="100%" cellspacing="0" bordercolor="#FFFFFF" class="TableMenu">
            <tr>
              <td width="25%" class="ButtonSel" nowrap>Premiership League</td>
              <td width="25%" class="ButtonPro"><?php $team_id = $_GET["team_id"]; ?><a href="/fmol/page/division/schedule.php?team_id=<?=$team_id?>">Schedule</a></td>
