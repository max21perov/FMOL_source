      ...
      <tr>
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
            ...
            <td width="100" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Give Price</a></td>
            <td>&nbsp;</td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="100%" cellspacing="0" class="TableMenu" >
              <tr>
				<td class="gSGSectionTitle_gray"><div align="center" class="gSGSectionTitle">Give Price</div></td>
              </tr>
          </table></td>
        </tr>
        <tr>
		  ...
		  <?php 
		    $player_id = $_GET['player_id'];
		    require_once ('give_price_maker.php'); 
		  ?>
          </td>
        </tr>
      </table>     
