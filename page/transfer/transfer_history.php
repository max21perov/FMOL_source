...
<table width="995" border="0" align="center" cellpadding="0" cellspacing="1">
      ...
      <tr>
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
            ...
            <td width="80" align="center" nowrap><a href="/fmol/page/transfer/transfer_hotlist.php">Hot List</a></td>
            <td width="20" align="center">-&gt;</td>
            <td width="120" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Transfer History</a></td>
            <td>&nbsp;</td>
  ...
  <tr class="BodyTable">  
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table width="100%" border="1" align="left" cellpadding="0" cellspacing="0">
          <tr>
            <td><table width="100%" bgColor="#0069b9" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="MenuText">&nbsp;&nbsp;<a href="/fmol/page/transfer/give_price.php?player_id=<script>document.getElementsByName('checkbox[]')[0]</script>">&nbsp;Give a price</a></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="100%" cellspacing="0" class="TableMenu" >
              <tr>
                <td width="20%" class="ButtonPro"><a href="/fmol/page/transfer/transfer_hotlist.php">Hot List</a></td>
                ...
                <td width="20%" class="ButtonSel">Transfer History</td>
              </tr>
			  <tr>
        ...
        <tr>
          <td>
		  <?php 
		    require_once ('transfer_history_maker.php'); 
		  ?>
          </td>
        </tr>
      </table>  
