      ...
      <tr>
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
            ...
            <td width="100" align="center" nowrap><a href="#" onClick="history.go(-1);">Player Info</a></td>
            <td width="20" align="center">-&gt;</td>
            <td width="130" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Put To Transfer</a></td>
            <td>&nbsp;</td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="100%" cellspacing="0" class="TableMenu" >
              <tr>
			    <td class="gSGSectionTitle_gray"><div align="center" class="gSGSectionTitle">Put To Transfer Market </div></td>
        ...
        <tr>
		  ...
		  <?php 
		    $player_id = $_GET['player_id'];
		    require_once ('put_to_transfer_maker.php'); 
		  ?>
          </td>
        </tr>
      </table>     
