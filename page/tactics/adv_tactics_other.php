        ...
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
			...
			<!-- InstanceBeginEditable name="EditNavigation" -->
	 		...
	 		<td width="100" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Adv. Tactics</a></td>
            <td>&nbsp;</td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="100%" cellspacing="0" class="TableMenu" >
              <tr>
                <td width="25%" class="ButtonSel">Tactics A</td>
                <td width="25%" class="ButtonPro">Tactics B</td>
                <td width="25%" class="ButtonPro">Tactics C</td>
              </tr>
          </table></td>
        </tr>
        <tr>
		  ...
		  <iframe name="tactics_frame" src="adv_tactics_other_maker.php?team_id=<?=$team_id?>" frameborder="0" width="100%" height="700" marginwidth="0" marginheight="0"></iframe>
          </td>
        </tr>
      </table>
