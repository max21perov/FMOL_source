      ...
      <tr>
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
            ...
            <td width="80" align="center" nowrap><a href="/fmol/page/tactics/tactics_cur.php">Tactics</a></td>
            <td width="20" align="center">-&gt;</td>
            <td width="120" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Role List</a></td>
            <td>&nbsp;</td>  
       ...
       <tr>
          <td><table width="100%" cellspacing="0" class="TableMenu" >
              <tr>
                ...
                <td class="ButtonSel">Role List</td>
        ...
        <tr>
          <td>
		    ...
		    <iframe src="role_list_maker.php?team_id=<?=$team_id?>" frameborder="0" width="100%" height="700" marginwidth="0" marginheight="0"></iframe>
