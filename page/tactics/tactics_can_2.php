      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="100%" cellspacing="0" class="TableMenu" >
              <tr>
                ...
                <td width="25%" class="ButtonSel">Can B</td>
        ...
        <tr>
          <td>
		    ...
		    <iframe name="tactics_frame" src="tactics_can_2_maker.php?team_id=<?=$team_id?>" frameborder="0" width="100%" height="700" marginwidth="0" marginheight="0"></iframe>
