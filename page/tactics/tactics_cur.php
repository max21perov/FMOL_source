...
<table width="995" border="0" align="center" cellpadding="0" cellspacing="1">
        ...
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
			...
			<!-- InstanceBeginEditable name="EditNavigation" -->
	 		...
	 		<td width="80" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Tactics</a></td>
            <td>&nbsp;</td>
  ...
  <tr class="BodyTable">  
	...
	<?php 
	  require_once (DOCUMENT_ROOT . "/template_php/menu_tactics.tpl.php");
	?>
	<!-- InstanceEndEditable -->
      </div></td> 
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="100%" cellspacing="0" class="TableMenu" >
              <tr>
                <td width="25%" class="ButtonSel">Cur</td>
                <td width="25%" class="ButtonPro"><a href="/fmol/page/tactics/tactics_can_1.php">Can A</a></td>
                <td width="25%" class="ButtonPro"><a href="/fmol/page/tactics/tactics_can_2.php">Can B</a></td>
                <td width="25%" class="ButtonPro"><a href="/fmol/page/tactics/tactics_can_3.php">Can C</a></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td>
			<?php $team_id = $_SESSION['s_primary_team_id']; ?>
		    <iframe name="tactics_frame" src="tactics_cur_maker.php?team_id=<?=$team_id?>" frameborder="0" width="100%" height="700" marginwidth="0" marginheight="0"></iframe>
