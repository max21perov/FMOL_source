      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="100%" cellspacing="0" class="TableMenu" >
              <tr>
                <td width="33%" class="ButtonSel">Tactics</td>
                <td width="33%" class="ButtonPro"><a href="/fmol/page/tactics/command_list.php">Command List</a></td>
                <td width="33%" class="ButtonPro"><a href="/fmol/page/tactics/role_list.php">Role List</a></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td>
		    ...
		    <iframe name="tactics_frame" src="tactics_easy_maker.php?team_id=<?=$team_id?>" frameborder="0" width="100%" height="700" marginwidth="0" marginheight="0"></iframe>
