...
// get the can_tactics_id_3 from team_tactics
$p_tactics_id = getCan_tactics_id_3($db, $team_id);


$tpl->setVariable("COPY_TO_CUR_TACTICS_DISPLAY", "block");
$tpl->setVariable("RETURN_PAGE_URL", "/fmol/page/tactics/tactics_can_3.php");
...
//----------------------------------------------------------------------------
/**
 * get can_tactics_id_3 from team_tactics
 *
 ...
 * @return  $p_tactics_id
 */	
function getCan_tactics_id_3($db, $team_id)
{
	$p_tactics_id = "0";
	
	// std_formation
	$query = sprintf( 
			 	" SELECT can_tactics_id_3 as p_tactics_id " .
			 	" FROM team_tactics " .
			 	" WHERE team_id='%s' " , 
			 	$team_id
			 	);
