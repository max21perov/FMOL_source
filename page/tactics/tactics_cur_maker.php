...
// get the p_tactics_id from team_tactics
$p_tactics_id = getCur_tactics_id($db, $team_id);



$tpl->setVariable("COPY_TO_CUR_TACTICS_DISPLAY", "none");
$tpl->setVariable("RETURN_PAGE_URL", "/fmol/page/tactics/tactics_cur.php");
