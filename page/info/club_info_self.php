...
<table width="995" border="0" align="center" cellpadding="0" cellspacing="1">
  ...
  <tr class="BodyTable">  
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	 <tr><td>
	 <table width="100%" cellspacing="0" class="TableMenu" >
        <tr>
          <td width="25%" class="ButtonSel">Information</td>
          <td width="25%" class="ButtonPro">Sponsor</td>
          <td width="25%" class="ButtonPro"><a href="/fmol/page/info/club_info_edit.php">Edit</a></td>
	 ...
	 <tr><td>
	  <?php require_once(DOCUMENT_ROOT . "/page/mail/simple_mail_maker.php"); ?>
	 </td></tr>
	</table>
