        ...
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
			...
			<!-- InstanceBeginEditable name="EditNavigation" -->
	 		...
	 		<td width="80" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Info</a></td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td class="MenuText">&nbsp;&nbsp;<a href="/fmol/page/mail/send_mail.php?team_id=<?=$team_id?>" title="send email">Mail</a></td>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td><table width="100%" cellspacing="0" class="TableMenu" >
            <tr>
              <td width="25%" class="ButtonSel">Information</td>
              <td width="25%" class="ButtonPro">Sponsor</td>
              <td width="25%" class="ButtonPro">Edit</td>
      ...
      <tr>
        <td>
		  <?php 
		    $team_id = $_GET["team_id"];
			require_once ("club_info_maker.php");
		  ?>
