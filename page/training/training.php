        ...
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
			...
			<!-- InstanceBeginEditable name="EditNavigation" -->
	 		...
	 		<td width="80" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Training</a></td>
            <td>&nbsp;</td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="100%" cellspacing="0" class="TableMenu" >
              <tr>
                <td class="ButtonSel">Training</td>
              </tr>
          </table></td>
        </tr>
        <tr>
		  ...
		  <iframe src="training_maker.php?team_id=<?=$team_id?>" frameborder="0" width="100%" height="700" marginwidth="0" marginheight="0"></iframe>
          </td>
        </tr>
      </table>  
