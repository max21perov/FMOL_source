      ...
      <tr>
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
            ...
            <td width="120" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Who's Online</a></td>
            <td>&nbsp;</td>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td><table width="100%" cellspacing="0" class="TableMenu" >
            <tr>
              <td width="33%" class="ButtonPro"><a href="/fmol/page/mail/mail.php" >News</a></td>
              <td width="33%" class="ButtonSel">Who's Online</td>
              <td width="33%" class="ButtonPro">Other</td>
            </tr>
        </table></td>
      </tr>
      <tr>
        <td>
		  <?php 
		  		require_once ("online_list_maker.php"); 
		  ?>
        </td>
      </tr>
    </table>
