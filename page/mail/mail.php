        ...
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
			...
			<!-- InstanceBeginEditable name="EditNavigation" -->
	 		...
	 		<td width="80" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">News</a></td>
            <td>&nbsp;</td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="100%" cellspacing="0" class="TableMenu" >
              <tr>
                <td width="33%" class="ButtonSel">News</td>
                <td width="33%" class="ButtonPro"><a href="/fmol/page/mail/online_list.php" >Who's Online</a></td>
		 ...
		 <tr><td>
		  <?php 
		  		require_once ("mail_main_maker.php"); 
		  ?>
		 </td></tr>
