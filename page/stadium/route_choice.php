      ...
      <tr>
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
            ...
            <td width="80" align="center" nowrap><a href="/fmol/page/stadium/stadium.php">stadium</a></td>
            <td width="20" align="center">-&gt;</td>
            <td width="120" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Route Choice</a></td>
            <td>&nbsp;</td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
        <tr>
          <td><table cellspacing="0" class="TableMenu">
              <tr>
                <td class="ButtonSel">Stadium</td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td><?php require_once('route_choice_maker.php'); ?></td>
        </tr>
      </table>
