        ...
        <td height="25" ><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr class="MenuText">
			...
			<!-- InstanceBeginEditable name="EditNavigation" -->
	 		...
	 		<td width="120" align="center"><a href="<?=$_SERVER['REQUEST_URI']?>">Future Fixtures</a></td>
            <td>&nbsp;</td>
  ...
  <tr class="BodyTable">  
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr class="ProText">
        <td>
            <table width="100%" cellspacing="0" class="TableMenu" >
              <tr>
                <td class="ButtonSel">Fixtures </td>
              </tr>
            </table>
        </td>
      </tr>
      <tr>
		...
		<?php 
		  $team_id = $_GET["team_id"];
		  $tpl_file_name = "fixtures_other.tpl.php";
		  require_once('fixtures_maker.php'); 
		?>
		</td>
      </tr>
    </table>
